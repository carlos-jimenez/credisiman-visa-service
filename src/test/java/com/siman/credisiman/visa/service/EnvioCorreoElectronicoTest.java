...
public class EnvioCorreoElectronicoTest {
    ...
    public void obtenerConsultaSubProductosOk() {
        ...
        XmlObject result = EnvioCorreoElectronico.send("no-reply@simaninternet.net",
                "CREDISIMAN EL SALVADOR","prueba de corrreo",false,"<p>prueba de correo</p>",
                "kwdXSolNtPMoFsBXKSgZDQ1", "NotificacionBienvenida",emails);
